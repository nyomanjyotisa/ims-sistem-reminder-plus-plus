...
class ConnectionManager
{
	...
	{
		return $this->byId( "notif_basic1_at_menkz_xyz" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "notif_basic1_at_menkz_xyz";
		$data["connName"] = "notif_basic1 at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;notif_basic1;;1"; //currently unused

		$this->_connectionsIdByName["notif_basic1 at localhost"] = "notif_basic1_at_menkz_xyz";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=notif_basic1;OPTION=3";
		// encription set
		...
		$connectionsData["notif_basic1_at_menkz_xyz"] = $data;
