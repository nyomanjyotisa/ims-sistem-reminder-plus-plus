...
require_once("include/show_not_reviewed_order_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "show_not_reviewed_order" );
