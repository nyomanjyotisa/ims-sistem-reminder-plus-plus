...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "notif_basic1_at_menkz_xyz" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "channel", "varname" => "notif_basic1_at_menkz_xyz__channel", "altvarname" => "channel", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			...
			$dalTables[$conn->connId][] = array("name" => "group_user_type", "varname" => "notif_basic1_at_menkz_xyz__group_user_type", "altvarname" => "group_user_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "membership_type", "varname" => "notif_basic1_at_menkz_xyz__membership_type", "altvarname" => "membership_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "order_type", "varname" => "notif_basic1_at_menkz_xyz__order_type", "altvarname" => "order_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "personal", "varname" => "notif_basic1_at_menkz_xyz__personal", "altvarname" => "personal", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "product_type", "varname" => "notif_basic1_at_menkz_xyz__product_type", "altvarname" => "product_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "province", "varname" => "notif_basic1_at_menkz_xyz__province", "altvarname" => "province", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "stock_type", "varname" => "notif_basic1_at_menkz_xyz__stock_type", "altvarname" => "stock_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
		}
	}
