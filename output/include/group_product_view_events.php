 ...
 */
 ...
 class eventclass_group_product_view  extends eventsBase
{
...
$sql = "SELECT `group_product`.group_product_id, `group_product`.product_name, `group_product`.price FROM group_product 
            INNER JOIN `group` ON group_product.`group_id`=`group`.`group_id`
            WHERE `group`.`group_id` =" . $_GET[ "group_id" ];
