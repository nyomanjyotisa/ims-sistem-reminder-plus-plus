...
class tDAL
{
	...
	var $tblnotif_basic1_at_menkz_xyz__province;
	var $tblnotif_basic1_at_menkz_xyz__stock_type;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "province", "varname" => "notif_basic1_at_menkz_xyz__province", "altvarname" => "province", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
		$this->lstTables[] = array("name" => "stock_type", "varname" => "notif_basic1_at_menkz_xyz__stock_type", "altvarname" => "stock_type", "connId" => "notif_basic1_at_menkz_xyz", "schema" => "", "connName" => "notif_basic1 at localhost");
	}
