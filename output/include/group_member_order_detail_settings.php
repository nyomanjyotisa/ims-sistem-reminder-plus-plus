...
$tdatagroup_member_order_detail[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"search\":[\"search\"]}" );
$tdatagroup_member_order_detail[".originalPagesByType"] = $tdatagroup_member_order_detail[".pagesByType"];
$tdatagroup_member_order_detail[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"search\":[\"search\"]}" ) );
$tdatagroup_member_order_detail[".originalPages"] = $tdatagroup_member_order_detail[".pages"];
$tdatagroup_member_order_detail[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"search\":\"search\"}" );
...
$tdatagroup_member_order_detail[".entityType"] = 1;
$tdatagroup_member_order_detail[".connId"] = "notif_basic1_at_menkz_xyz";
...
$tdatagroup_member_order_detail[".badgeColor"] = "D2AF80";
...
$masterTablesData["group_member_order_detail"] = array();
	...
	$masterTablesData["group_member_order_detail"][0]["masterKeys"][]="group_product_id";
				$masterTablesData["group_member_order_detail"][0]["detailKeys"] = array();
	$masterTablesData["group_member_order_detail"][0]["detailKeys"][]="group_product_id";
