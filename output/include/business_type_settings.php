...
$tdatabusiness_type[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatabusiness_type[".originalPagesByType"] = $tdatabusiness_type[".pagesByType"];
$tdatabusiness_type[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatabusiness_type[".originalPages"] = $tdatabusiness_type[".pages"];
$tdatabusiness_type[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdatabusiness_type[".connId"] = "notif_basic1_at_menkz_xyz";
...
$tdatabusiness_type[".badgeColor"] = "CD853F";
